...
def run_rustest(project_dir, *args):
    ...
    cmd = [python_path, "-m", "rustest", str(project_dir), "--color", "never", *args]
...
def test_loop_scope_mismatch_error_message(loop_scope_mismatch_project):
    ...
    result = run_rustest(loop_scope_mismatch_project)
    ...
    assert "Loop scope mismatch" in output, f"Expected 'Loop scope mismatch' in output: {output}"
...
def test_loop_scope_mismatch_class_error_message(loop_scope_mismatch_class_project):
    ...
    result = run_rustest(loop_scope_mismatch_class_project)
...
def test_compatible_loop_scope_passes(no_mismatch_project):
    ...
    result = run_rustest(no_mismatch_project)
