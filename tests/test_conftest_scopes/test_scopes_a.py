...
def test_function_scope_1(function_fixture, session_fixture):
    """Each test should get a function-scoped fixture."""
    assert function_fixture == "function_value"
    assert session_fixture == "session_value"


def test_function_scope_2(function_fixture, session_fixture):
    """Second test in same module."""
    assert function_fixture == "function_value"
    assert session_fixture == "session_value"


def test_module_scope(module_fixture, session_fixture):
    """Module fixture should work."""
    assert module_fixture == "module_value"
    assert session_fixture == "session_value"


def test_module_scope_reused(module_fixture, session_fixture):
