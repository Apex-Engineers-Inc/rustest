...
| Fast CI/CD runs | ⚠️ | ✅ | 1.1x–5.7x across [seventeen real suites](performance.md); ~37x on collection alone |
...
- You want faster test execution — measured at **1.1x–5.7x** on seventeen real
  open-source pytest suites ([the table](performance.md))
- Your suite spends a meaningful share of its wall clock in the *framework* rather than in
  ...
  [Performance](performance.md) shows you how to work out roughly what yours is before you
  migrate
