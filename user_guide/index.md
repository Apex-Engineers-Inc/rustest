...
Start at [Why automated testing?](intro-why-test.md). The beginner track assumes nothing. It
walks from "why bother" through your first test, fixtures, parametrization and how to
...
- [Upgrade guide](migration-guide.md), the breaking changes if you are coming from an older
  rustest
...
[Performance](performance.md) has the full table, the method, and the caveats, including the
